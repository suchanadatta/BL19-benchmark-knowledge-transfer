...
public class FactoredRLM {
    ...
    public FactoredRLM(RelevanceFeedback rbcm) throws IOException {
        ...
        this.numFeedbackTerms = rbcm.numFeedbackTerms;
     ...
     * @throws IOException 
     */
    public void setFeedbackStats(TopDocs topDocs, String[] analyzedQuery, RelevanceFeedback rbcm) throws IOException {
...
//        System.out.println("hit length : " + hits_length);
//        int hits_start = hits_length/3;
//        int hits_end = 2 * hits_start;
//        System.out.println("hit starts at : " + hits_start + "hit ends at : " + hits_end);
//        
//        for (int i = hits_start; i < hits_end; i++) {
//            // for each feedback document
//            int luceneDocId = hits[i].doc;
//            Document d = indexSearcher.doc(luceneDocId);
//            DocumentVector docV = new DocumentVector(rbcm.fieldForFeedback);
